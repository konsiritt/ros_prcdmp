...
void DmpVelocityExampleController::initROSCommunication(){
    ...
    subCoupling = nodeHandle->subscribe("/coupling_term_estimator/coupling_term", 1, &DmpVelocityExampleController::ctCallback, this);
}

bool DmpVelocityExampleController::checkRobotSetup(){
...
bool DmpVelocityExampleController::loadDmpData(int &nBFs, double &dt, std::vector<double> &y0v,
...
void DmpVelocityExampleController::initDmpObjects(int &nBFs, double &dt, std::vector<double> &initialPosition,
...
bool DmpVelocityExampleController::checkRobotInit() {
...
void DmpVelocityExampleController::checkStoppingCondition(){
...
void DmpVelocityExampleController::commandRobot(const std::vector<double> &dq){
    double omega = 0.0;
    int it = 0;
...
void DmpVelocityExampleController::ctCallback(const common_msgs::CouplingTerm::ConstPtr& msg) {
